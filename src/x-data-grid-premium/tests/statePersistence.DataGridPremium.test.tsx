...
describe('<DataGridPremium /> - State persistence', () => {
  ...
  describe('apiRef: exportState', () => {
    it('should export the initial values of the models', () => {
      ...
      expect(exportedState.rowGrouping).toEqual(FULL_INITIAL_STATE.rowGrouping);
      expect(exportedState.aggregation).toEqual(FULL_INITIAL_STATE.aggregation);
    });
    ...
    it('should export the controlled values of the models', () => {
      ...
      expect(apiRef.current.exportState().rowGrouping).toEqual(
        FULL_INITIAL_STATE.rowGrouping,
      );
      expect(apiRef.current.exportState().aggregation).toEqual(
