...
export const useGridExcelExport = (
  ...
  >(
    async (options = {}) => {
      ...
      const serializedColumns = serializeColumns(
        exportedColumns,
        options.columnsStyles || {}
      );
      ...
      const columnGroupPaths = exportedColumns.reduce<Record<string, string[]>>(
        (acc, column) => {
  ...
  useGridApiOptionHandler(
    ...
    props.onExcelExportStateChange
  );
};
