...
describe('createRowTree', () => {
  describe('group expansion', () => {
    it('should not expand the groups when defaultGroupingExpansionDepth === 0', () => {
      ...
      expect(getGroupExpansion(response.tree)).toEqual([
  ...
  describe('tree - parent and children', () => {
    it('should link parent and children in the tree', () => {
      ...
      expect((response.tree[GRID_ROOT_GROUP_ID] as GridGroupNode).children).toContain(0);
      expect(response.tree[0].parent).toEqual(GRID_ROOT_GROUP_ID);
      expect((response.tree[0] as GridGroupNode).children).toContain(1);
      expect(response.tree[1].parent).toEqual(0);
    });
    ...
    it('should add auto generated row when missing parent', () => {
      ...
      expect((response.tree[0] as GridGroupNode).children).toContain(
        'auto-generated-row-null/A-null/A',
      );
      expect(response.tree['auto-generated-row-null/A-null/A'].parent).toEqual(0);
      expect(response.tree[1].parent).toEqual('auto-generated-row-null/A-null/A');
    });
    ...
    it('should allow to have a non-auto-generated group as children of an auto-generated-group', () => {
      ...
      expect(response.tree[0].parent).toEqual('auto-generated-row-null/A');
      expect((response.tree['auto-generated-row-null/A'] as GridGroupNode).children).toContain(0);
      expect(response.tree[1].parent).toEqual(0);
      expect((response.tree[0] as GridGroupNode).children).toContain(1);
    });
    ...
    it('should allow to have two rows with the same field at various depth', () => {
      ...
      // "V2"
      //    "LEAF"
      expect(response.tree[0].parent).toEqual('auto-generated-row-F1/V1-F2/V2');
      expect(
        (response.tree['auto-generated-row-F1/V1-F2/V2'] as GridGroupNode).children,
      ).toContain(0);

      expect(response.tree[1].parent).toEqual('auto-generated-row-F2/V2');
      expect((response.tree['auto-generated-row-F2/V2'] as GridGroupNode).children).toContain(1);
    });
  ...
  describe('tree depth', () => {
    it('should track the node count at each depth of the tree', () => {
      ...
      expect(response.treeDepths).toEqual({ 0: 1, 1: 1, 2: 2 });
    });
  });
});