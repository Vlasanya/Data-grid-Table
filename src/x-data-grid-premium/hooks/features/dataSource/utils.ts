...
export const runIfServerMode =
  (modeProp: "server" | "client", fn: Function) => () => {
    if (modeProp === "server") {
      fn();
    }
  };
...
export class NestedDataManager {
  ...
  public getActiveRequestsCount = () =>
    this.pendingRequests.size + this.queuedRequests.size;
}
