...
describe("<DataGridPro /> - Column pinning", () => {
  ...
  describe("props: onPinnedColumnsChange", () => {
    ...
    //   );
    //   expect(handlePinnedColumnsChange.mock.calls[0][0]).toHaveBeenCalledWith({
    //     left: ["currencyPair"],
    //     right: [],
    //   });
    //   act(() =>
  ...
  describe("apiRef", () => {
    ...
    describe("unpinColumn", () => {
      it("should unpin the given column", () => {
        ...
        expect($$(`.${gridClasses["cell--pinnedLeft"]}`).length).not.toEqual(
          0
        );
  ...
  describe("restore column position after unpinning", () => {
    ...
    //   ]);
    //   rerender(
    //     <TestCase pinnedColumns={{ left: ["currencyPair", "id"], right: ["__check__"] }} />
    //   );
    //   expect(getColumnHeadersTextContent()).toEqual([
    //     "Currency Pair",
    //     "id",
    ...
    //   ]);
    //   rerender(
    //     <TestCase pinnedColumns={{ left: [], right: [] }} />
    //   );
    //   expect(getColumnHeadersTextContent()).toEqual([
    //     "",
    //     "id",
    ...
    //   ]);
    //   rerender(
    //     <TestCase pinnedColumns={{ left: ["currencyPair"]}} />
    //   );
    //   expect(getColumnHeadersTextContent()).toEqual([
    //     "Currency Pair",
    //     "id",
    ...
    //   ]);
    //   rerender(
    //     <TestCase pinnedColumns={{ left: ["currencyPair", "foo"]}} />
    //   );
    //   expect(getColumnHeadersTextContent()).toEqual([
    //     "Currency Pair",
    //     "foo",
    ...
    it("should restore the position of a column unpinned after a column is removed", () => {
      ...
      rerender(
        <TestCase columns={[{ field: "id" }, { field: "price1M" }]} />
      );
      expect(getColumnHeadersTextContent()).toEqual(["price1M", "id"]);
      rerender(
        <TestCase columns={[{ field: "id" }, { field: "price1M" }]} pinnedColumns={{}} />
      );
    ...
    it("should not crash when removing a pinned column", () => {
      ...
      rerender(
        <TestCase pinnedColumns={{right: []}} columns={[{ field: "id" }, { field: "price1M" }]} />
      );
      expect(getColumnHeadersTextContent()).toEqual(["id", "price1M"]);
    });
  });
