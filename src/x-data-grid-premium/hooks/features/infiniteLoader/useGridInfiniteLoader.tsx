...
import { GridRowScrollEndParams } from "../../../models/gridRowScrollEndParams";
...
export const useGridInfiniteLoader = (
  ...
  const isEnabled =
    props.rowsLoadingMode === "client" && !!props.onRowsScrollEnd;
  ...
  const getInfiniteLoadingTriggerElement = React.useCallback<
    NonNullable<
      GridInfiniteLoaderPrivateApi["getInfiniteLoadingTriggerElement"]
    >
  >(
    ({ lastRowId }) => {
      if (!isEnabled) {
