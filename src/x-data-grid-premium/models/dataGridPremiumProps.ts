...
export interface GridExperimentalPremiumFeatures
  extends GridExperimentalProFeatures {
  /**
 ...
 */
export interface DataGridPremiumPropsWithDefaultValue<
