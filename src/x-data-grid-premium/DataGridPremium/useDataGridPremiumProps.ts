...
import { GRID_DEFAULT_LOCALE_TEXT, GridSignature } from "@mui/x-data-grid";
import { DataGridProProps } from "../models/dataGridProProps";
import { DATA_GRID_PRO_PROPS_DEFAULT_VALUES } from "./useDataGridProProps";
...
const getDataGridPremiumForcedProps: GetDataGridProForcedProps = (
  themedProps
) => ({
